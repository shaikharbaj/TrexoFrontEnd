...
import { CreateUpdateBrandModal } from "@/components/modals";
import { BrandTable } from "@/components/tables";
import { openPopup } from "@/service/modal.service";

interface IBrandProps { }

const BrandList: React.FunctionComponent<IBrandProps> = () => {
    ...
    <div className="space-y-6">
      <div className="flex items-center flex-wrap justify-between gap-4">
        <Breadcrumbs>
          ...
          <BreadcrumbItem>{t("Brand")}</BreadcrumbItem>
        </Breadcrumbs>
      </div>
      <div className="space-y-6">
        <div className="flex items-center flex-wrap justify-between gap-4">
